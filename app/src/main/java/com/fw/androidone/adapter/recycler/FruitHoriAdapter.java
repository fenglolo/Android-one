 ...
 * date : 2021/3/4 16:52
 */
public class FruitHoriAdapter extends RecyclerView.Adapter<FruitHoriAdapter.ViewHolder> {

    List<Fruit> list = new ArrayList<>();

    public FruitHoriAdapter(List<Fruit> list) {
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fruit_hori, parent, false);
